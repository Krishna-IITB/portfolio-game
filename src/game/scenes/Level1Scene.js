...
// import iitbInfo from '../../data/iitb-info.json';
...
//     // 5) Create all 8 zones (Hover + Mobile Ready)
...
//     this.add.text(50, 672, '🖱️ Hover=Instant | 📱 A/D/Jump/←→ | ⌨️ WASD+E', {
//       fontSize: '16px',
//       color: '#ffffff',
//       fontStyle: 'bold',
//       stroke: '#000000',
...
//     // Hint
//     const hint = this.add.text(x, y + 70, isDoor ? 'Hover/E →' : 'Hover/E', {
...
//     // 🖱️ MOUSE HOVER - Auto-trigger modals
...
export default class Level1Scene extends Phaser.Scene {
  ...
  // ✅ UPDATED: Skills Door (instead of Skills Orb)
  createZone7Skills() {
    this.createBeautifulCard({
      x: 2250, y: 460, icon: '⚡', label: 'Skills',
      description: 'Arena →', color: 0x9333ea,
      target: { type: 'skillsDoor' }, isDoor: true
    });
  }
  ...
  handleInteraction(target) {
    ...
    switch (target.type) {
      ...
      // ✅ NEW: Skills Door handler
      case 'skillsDoor':
        this.scene.start('Level1SkillsScene');
        break;
